          ...
          <div class="box table" style="width:100%">
            <table cellspacing="0" width="100%">
              ...
              <?php
				...
				$srt_qry = "select * from tbl_jobs where status = 'complete' order by ".$_REQUEST['srt_opt']." ".$_REQUEST['srt_typ'];	
				}
				else{
				$srt_qry = "select * from tbl_jobs where status = 'complete' order by id desc";
				}
				//echo $srt_qry;
$test = new MyPagina;
// create query
