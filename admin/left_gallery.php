        ...
        <div class="grid_12">
          ...
          <div class="box table">
            ...
            <table border="0" cellpadding="2" cellspacing="0" width="70%" style="padding:15px; margin:auto">
              <tr>
              	<td align="left" style="font-size:10px; color:#F00" colspan="2">* Image Dimension: 645px x 250px</td>
        	  </tr>
              <tr>
            ...
            <table width="100%" cellspacing="0" cellpadding="4" border="0" align="center" class="greyBorder">
                <thead>
                    ...
                    <tbody>
                    <?php 
                        $q = mysql_query("select * from tbl_gallery where type='left' order by image_id DESC");
							...
							while($row = mysql_fetch_array($q))
							{
								...
								<tr>
									...
									<td style="padding:0px">
										<a href="left_gallery.php?image_id=<?=$row[image_id]?>&image_file=<?=$row[image_file]?>&act=d" onclick="confirm('Are you sure you want to delete this image');">
