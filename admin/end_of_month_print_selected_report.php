...
$idlist = explode('|',$starting_id);
$starting_id = '';
for ($ix = 1; $ix < count($idlist) ; $ix++) {
   $starting_id.= $idlist[$ix-1].' , ';
   }
$starting_id = substr($starting_id,0,-3);

$q1 = "SELECT * from eom_tbl where id in (".$starting_id.") order by id";
