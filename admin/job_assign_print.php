...
$form_qry = "SELECT * FROM tbl_form WHERE ".$cond;
...
if(isset($_REQUEST['submit'])){
	...
	$s = "SELECT * FROM tbl_jobs WHERE ".$cond;
	$s_e = mysql_query($s);
	$s_e1 = mysql_query($s);
...
day = new Date();
id = day.getTime();
eval("page" + id + " = window.open(URL, '" + id + "', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=850,height=600,left = 100,top = 100');");
}
// End -->
function add_feed()
{
...
<style>
    ...
    <div id="page-content"> 
        ...
        <a href="#" onclick="printpage()"><input type="button" name="print" value="Print Page" /></a>
<div class="grid_12">
        <?php 
		while($s_f1= mysql_fetch_array($s_e1)){
			?>
	...
	<tr>
		<td valign="top" style="vertical-align:top">
			...
			<td ><input type="text" disabled="disabled" value="<?php echo $s_f['ref_physican'];?>" name="ref_physican" width="300px" /></td>
			</tr>
					<tr>

						<td >Address:</td>
						<td valign="top" align="left"><input type="text" disabled="disabled" value="<?php echo $s_f['address'];?>" name="address" /></td>
					</tr>	
			<tr>

										<td valign="top" align="right" width="20%">Office Phone:</td>
										<td valign="top" align="left"><input type="text" disabled="disabled" value="<?php echo $s_f['office_phone'];?>" name="office_phone" /></td>
									</tr>	
				<tr>
					<td valign="top" align="right" width="20%">Tax ID#:</td>
					<td valign="top" align="left"><input type="text" disabled="disabled" value="<?php echo $s_f['tax_id'];?>" name="tax_id" /></td>
				</tr>		
				<tr>
					<td valign="top">PCP's Name:</td>
					<td>
						<input type="text" disabled="disabled" value="<?php echo $s_f['pcp_name'];?>" name="pcp_name" />
				...
				<tr>
					        ...
					        <td valign="top" align="left"><input type="text" disabled="disabled" value="<?php echo $s_f['fax'];?>" name="fax" /></td>
						</tr>
						<tr>

					        <td valign="top" align="right" width="20%">NPI#:</td>
					        <td valign="top" align="left"><input type="text" disabled="disabled" value="<?php echo $s_f['npi'];?>" name="npi" /></span></td>
						</tr>
						<tr>
		...
		<table>
			<tr>
				...
				<td valign="top" align="left"><input maxlength="2" type="text" value="<?php echo $s_f['appt_month'];?>" name="appt_month" style="width:30px" disabled="disabled" />-<input type="text" maxlength="2" style="width:30px" value="<?php echo $s_f['appt_day'];?>" name="appt_day" disabled="disabled" />-<input maxlength="4" type="text" value="<?php echo $s_f['appt_year']?>" name="appt_year" style="width:30px" disabled="disabled" /></td>
			</tr>
			<tr>
				<td valign="top" align="right" width="20%">Facility:</td>
				<td valign="top" align="left"><input type="text" disabled="disabled" value="<?php echo $s_f['facility'];?>" name="facility" /></td>
			</tr>	
				<tr>
						...
						<tr>
					        ...
					        <td valign="top" align="left"><input type="text" disabled="disabled" style="width:30px" value="<?php echo $s_f['appt_hrs'];?>" maxlength="2" name="appt_hrs" />-<input type="text" disabled="disabled" value="<?php echo $s_f['appt_min'];?>" maxlength="2" style="width:30px" name="appt_min" /></td>
						</tr>
		</table>
		</div>
		</td>
	...
	<tr>
		<td valign="top">
			...
			<tr>
					        ...
					        <td valign="top" align="left"><input type="text" disabled="disabled" value="<?php echo $s_f1['p_name'];?>" name="p_name" /></td>
						</tr>
						<tr>

					        <td valign="top" align="right" width="20%">Home#:</td>
					        <td valign="top" align="left"><input type="text" disabled="disabled" value="<?php echo $s_f1['p_hm'];?>" name="p_hm" /></td>
						</tr>
						<tr>

					        <td valign="top" align="right" width="20%">Cell#:</td>
					        <td valign="top" align="left"><input type="text" disabled="disabled" value="<?php echo $s_f1['p_cl'];?>" name="p_cl" /></td>
						</tr>
						<tr>

					        <td valign="top" align="right" width="20%">SSN:</td>
					        <td valign="top" align="left"><input type="text" disabled="disabled" value="<?php echo $s_f1['p_ssn'];?>" name="p_ssn" /></td>
						</tr>
						<tr>

					        <td valign="top" align="right" width="20%">Work#:</td>
					        <td valign="top" align="left"><input type="text" disabled="disabled" value="<?php echo $s_f1['p_wk'];?>" name="p_wk" /></td>
						</tr>
						<tr>

					        <td valign="top" align="right" width="20%">DOB:</td>
					        <td valign="top" align="left"><input type="text" disabled="disabled" value="<?php echo $s_f1['p_dob'];?>" name="p_dob" /></td>
						</tr>
						<tr>
							<td valign="top" align="right" width="20%">Notes:</td>
					        <td valign="top" align="left"><textarea name="job_notes"><?php echo $s_f1['job_notes'];?></textarea></td>
						</tr>
			</table>
		</td>
		<td width="15px">&nbsp;</td>
		...
		<table>
			<tr>
				...
				<td valign="top" align="left"><input type="text" disabled="disabled" value="<?php echo $s_f1['insurance_plan'];?>" name="insurance_plan" /></td>
			</tr>
						<tr>

					        <td valign="top" align="right" width="20%">Group#:</td>
					        <td valign="top" align="left"><input type="text" disabled="disabled" value="<?php echo $s_f1['group_no'];?>" name="group_no" /></td>
						</tr>

						<tr>

					        <td valign="top" align="right" width="20%">Secondary Insurance Plan:</td>
					        <td valign="top" align="left"><input type="text" disabled="disabled" value="<?php echo $s_f1['ins_plan_2'];?>" name="ins_plan_2" /></td>
						</tr>
						<tr>

					        <td valign="top" align="right" width="20%">Secondary Group#:</td>
					        <td valign="top" align="left"><input type="text" disabled="disabled" value="<?php echo $s_f1['ins_group_2'];?>" name="ins_group_2" /></td>
						</tr>
                        
						<tr>

					        <td valign="top" align="right" width="20%">Insurance Card:</td>
					        <td valign="top" align="left"><?php if($s_f1['ins_card'] != ""){?><a style="text-decoration:none; color:#333333;" href="../images/gallery/insurance/ins_<?php echo $s_f1['ins_card']; ?>">Insurance Card<?php }?></a></td>
						</tr>
					
						<tr>

					        <td valign="top" align="right" width="20%">Insurance Co:</td>
					        <td valign="top" align="left"><input type="text" disabled="disabled" value="<?php echo $s_f1['insurance_company'];?>" name="insurance_company" /></td>
						</tr>
						<tr>

					        <td valign="top" align="right" width="20%">Insurance Phone#:</td>
					        <td valign="top" align="left"><input type="text" disabled="disabled" value="<?php echo $s_f1['insurance_phone'];?>" name="insurance_phone" /></td>
						</tr>
						<tr>

					        <td valign="top" align="right" width="20%">Insurance ID#:</td>
					        <td valign="top" align="left"><input type="text" disabled="disabled" value="<?php echo $s_f1['insurance_id'];?>" name="insurance_id" /></td>
						</tr>
						...
						<tr>
					        ...
					        <td valign="top" align="left"><input type="text" disabled="disabled" value="<?php echo $s_f1['ins_comp_2'];?>" name="ins_comp_2" /></td>
						</tr>
						<tr>

					        <td valign="top" align="right" width="20%">Secondary Insurance Phone#:</td>
					        <td valign="top" align="left"><input type="text" disabled="disabled" value="<?php echo $s_f1['ins_phone_2'];?>" name="ins_phone_2" /></td>
						</tr>
						<tr>

					        <td valign="top" align="right" width="20%">Secondary Insurance ID#:</td>
					        <td valign="top" align="left"><input type="text" disabled="disabled" value="<?php echo $s_f1['ins_id_2'];?>" name="ins_id_2" /></td>
						</tr>
